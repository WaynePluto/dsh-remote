...
>
> ⚠️ pc2 的 dsh 需要信任 pc1 的地址：粘完命令后**重启一次 pc2 的 dsh-remote**，启动器会自动带上。公网域名模式下日常打开 `https://pc2.你的域名`；入口机器自己仍用 `http://127.0.0.1:30809` 或 `https://pc1.你的域名`。
