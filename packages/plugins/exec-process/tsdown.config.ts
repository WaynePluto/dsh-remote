...
const ID = '@dsh-remote/dsh-plugin-exec-process'
...
export default defineConfig([
  // Host half: the module dsh-overlay.yml inserts. It contributes no behaviour
  // — see src/index.ts for why it still has to exist.
  {
    name: `${ID}/host`,
    entry: ['src/index.ts'],
    format: 'esm',
