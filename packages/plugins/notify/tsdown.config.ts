...
const ID = '@dsh-remote/dsh-plugin-notify'
...
export default defineConfig([
  ...
  // exact service instances dsh is running — a second copy of the settings,
  // agent or session packages baked into this bundle would be a different set
  // of classes than the ones `ctx` hands out.
  {
    name: `${ID}/host`,
    entry: ['src/index.ts'],
    format: 'esm',
