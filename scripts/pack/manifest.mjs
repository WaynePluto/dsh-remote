...
/** 壳级常驻 overlay：remote-privileged 的 connection 注入，随 launcher 以 --patch 传入。 */
export const DSH_PLUGIN_FILES = [
  'node_modules/@dsh-remote/dsh-plugin-remote-privileged/dsh-overlay.yml',
]

/** 受管 Profile Bundle 必须随包携带的文件；与 launcher 的 MANAGED_PLUGIN_PACKAGES 同清单。 */
export const PROFILE_BUNDLE_FILES = [
  'node_modules/@dsh-remote/dsh-plugin-remote-settings/package.json',
  'node_modules/@dsh-remote/dsh-plugin-remote-settings/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-remote-settings/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-browser-compat/package.json',
  'node_modules/@dsh-remote/dsh-plugin-browser-compat/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-browser-compat/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-browser-compat/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-directory-picker-browse/package.json',
  'node_modules/@dsh-remote/dsh-plugin-directory-picker-browse/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-directory-picker-browse/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-proxy/package.json',
  'node_modules/@dsh-remote/dsh-plugin-proxy/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-proxy/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-proxy/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-copilot-auth/package.json',
  'node_modules/@dsh-remote/dsh-plugin-copilot-auth/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-models-catalog/package.json',
  'node_modules/@dsh-remote/dsh-plugin-models-catalog/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-model-capabilities/package.json',
  'node_modules/@dsh-remote/dsh-plugin-model-capabilities/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-favorite-models/package.json',
  'node_modules/@dsh-remote/dsh-plugin-favorite-models/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-turn-retry/package.json',
  'node_modules/@dsh-remote/dsh-plugin-turn-retry/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-turn-retry/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-turn-retry/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-exec-process/package.json',
  'node_modules/@dsh-remote/dsh-plugin-exec-process/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-chat-scroll/package.json',
  'node_modules/@dsh-remote/dsh-plugin-chat-scroll/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-user-message-fork/package.json',
  'node_modules/@dsh-remote/dsh-plugin-user-message-fork/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-agents-md/package.json',
  'node_modules/@dsh-remote/dsh-plugin-agents-md/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-agents-md/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-agents-md/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-notify/package.json',
  'node_modules/@dsh-remote/dsh-plugin-notify/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-notify/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-notify/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-services/package.json',
  'node_modules/@dsh-remote/dsh-plugin-services/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-services/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-services/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-terminal/package.json',
  'node_modules/@dsh-remote/dsh-plugin-terminal/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-terminal/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-terminal/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-tools-inspector/package.json',
  'node_modules/@dsh-remote/dsh-plugin-tools-inspector/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-skills-inspector/package.json',
  'node_modules/@dsh-remote/dsh-plugin-skills-inspector/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-files/package.json',
  'node_modules/@dsh-remote/dsh-plugin-files/cordis.patch.yml',
  'node_modules/@dsh-remote/dsh-plugin-files/dist/index.js',
  'node_modules/@dsh-remote/dsh-plugin-files/dist/client.js',
  'node_modules/@dsh-remote/dsh-plugin-subagent-depth/package.json',
  'node_modules/@dsh-remote/dsh-plugin-subagent-depth/cordis.patch.yml',
  ...
  'node_modules/@dsh-remote/dsh-plugin-yolo-mode/package.json',
  'node_modules/@dsh-remote/dsh-plugin-yolo-mode/cordis.patch.yml',
...
export function createManifest(root, { platform = process.platform, arch = process.arch } = {}) {
  ...
  return {
    ...
    profileBundleFiles: PROFILE_BUNDLE_FILES,
